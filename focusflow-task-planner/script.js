...
const el = {
  ...
  listWrap: $("list-wrap"), boardWrap: $("board-wrap"), listBtn: $("list-view"), boardBtn: $("board-view"),
  colHigh: $("col-high"), colMedium: $("col-medium"), colLow: $("col-low"),
  openCapture: $("open-capture"), captureDialog: $("capture-dialog"), captureForm: $("capture-form"), captureInput: $("capture-input"), closeCapture: $("close-capture")
};
