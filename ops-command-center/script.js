...
(() => {
    class OpsCommandCenter {
        constructor() {
            ...
            this.elements = {
                regionSelect: this.getById("region-select"),
                rangeSelect: this.getById("range-select"),
                ...
                navLinks: this.getMany(".nav-link"),
                themeToggle: this.getById("theme-toggle"),
                saveView: this.getById("save-view"),
                exportView: this.getById("export-view"),
                paletteOpen: this.getById("palette-open"),
                paletteDialog: this.getById("palette-dialog"),
                paletteActions: this.getMany(".palette-action")
            };
            this.bind();
            this.applyTheme();
            this.render();
        ...
        bind() {
            ...
            this.elements.navLinks.forEach((button) => {
                button.addEventListener("click", () => {
                    this.state.focus = button.dataset.focus ?? "overview";
                    this.persist();
                    this.renderFocus();
                });
            });
